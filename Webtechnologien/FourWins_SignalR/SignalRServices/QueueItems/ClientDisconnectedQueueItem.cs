//-----------------------------------------------------------------------
// <copyright file="ClientDisconnectedQueueItem.cs" company="FHWN">
...
namespace SignalRServices.QueueItems
{
    ...
    /// </summary>
    public class ClientDisconnectedQueueItem : IQueueItem
    {
        /// <summary>
        ...
        /// </exception>
        public ClientDisconnectedQueueItem(IClientContract receiver, string methodName, PlayerDisconnectedResponse response)
        {
            if (receiver == null)
