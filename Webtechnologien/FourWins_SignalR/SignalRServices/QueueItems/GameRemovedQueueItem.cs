//-----------------------------------------------------------------------
// <copyright file="GameRemovedQueueItem.cs" company="FHWN">
...
namespace SignalRServices.QueueItems
{
    ...
    /// </summary>
    public class GameRemovedQueueItem : IQueueItem
    {
        /// <summary>
        ...
        /// </exception>
        public GameRemovedQueueItem(IClientContract receiver, string methodName, GameRemovedResponse response)
        {
            if (receiver == null)
