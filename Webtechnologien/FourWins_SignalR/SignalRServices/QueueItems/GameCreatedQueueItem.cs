//-----------------------------------------------------------------------
// <copyright file="GameCreatedQueueItem.cs" company="FHWN">
...
namespace SignalRServices.QueueItems
{
    ...
    /// </summary>
    public class GameCreatedQueueItem : IQueueItem
    {
        /// <summary>
        ...
        /// </exception>
        public GameCreatedQueueItem(IClientContract receiver, string methodName, NewGameCreatedResponse response)
        {
            if (receiver == null)
