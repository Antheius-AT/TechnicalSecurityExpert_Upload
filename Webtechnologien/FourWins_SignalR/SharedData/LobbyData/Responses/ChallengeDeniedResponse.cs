//-----------------------------------------------------------------------
// <copyright file="ChallengeDeniedMessage.cs" company="FHWN">
...
namespace SharedData.LobbyData.ResponseMessages
{
    ...
    /// </summary>
    public class ChallengeDeniedResponse : IResponse
    {
        /// <summary>
        ...
        /// </exception>
        public ChallengeDeniedResponse(Challenge challenge, string message)
        {
            if (challenge == null)
        ...
        /// <summary>
        /// Gets the challenge that was denied.
        /// </summary>
