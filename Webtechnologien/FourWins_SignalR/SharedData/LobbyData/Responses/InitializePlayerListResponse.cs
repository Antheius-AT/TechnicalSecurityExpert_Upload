//-----------------------------------------------------------------------
// <copyright file="InitializePlayerListResponse.cs" company="FHWN">
...
namespace SharedData.LobbyData.ResponseMessages
{
    ...
    /// </summary>
    public class InitializePlayerListResponse : IResponse
    {
        /// <summary>
        ...
        /// </exception>
        public InitializePlayerListResponse(string message, IEnumerable<string> playerUsernames)
        {
            if (message == null)
